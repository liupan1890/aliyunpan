...
export default defineComponent({
  ...
  setup(props) {
    ...
    const handleOpen = () => {
      setTimeout(() => {
        const autofocus = document.getElementById('DaoRuShareMultiInput')
  ...
  <a-modal :visible="visible" modal-class="modalclass" @cancel="handleHide" @before-open="handleOpen" @close="handleClose" :footer="false" :unmount-on-close="true" :mask-closable="false">
    ...
    <div class="modalbody" style="width: 440px">
      <a-form ref="formRef" :model="form" layout="horizontal" auto-label-width>
        ...
        >
          <a-input v-model.trim="form.sharelink" @paste.stop.prevent="onPaste" placeholder="例如：aliyundrive.com/s/umaDDMR7w4F" allow-clear :input-attrs="{ id: 'DaoRuShareMultiInput', autofocus: 'autofocus' }" />
        </a-form-item>
