...
export function humanSize(bytes: number | string | undefined) {
...
export function humanSizeSpeed(bytes: number | string | undefined) {
  if (!bytes && bytes != 0) return ''
  if (typeof bytes === 'string') bytes = parseInt(bytes)
  let u = 0
...
export function humanTimeAgo(value: number | string | undefined) {
  if (!value) return ''
...
export function humanDateTime(value: number | string | undefined) {
  if (!value) return ''
  if (typeof value === 'string') value = parseInt(value)
  if (value > 1000000000 && value < 10000000000) value = value * 1000
  const date = new Date(value)
...
export function humanDateTimeYMD(value: number | string | undefined) {
  if (!value) return ''
  if (typeof value === 'string') value = parseInt(value)
  if (value > 1000000000 && value < 10000000000) value = value * 1000
  const date = new Date(value)
...
export function humanDateTimeDateStr(value: string | undefined) {
  if (!value) return ''
  const date = new Date(value)
  const y = date.getFullYear().toString()
  if (y == 'NaN') return ''
...
export function humanDateTimeDateStrYMD(value: string | undefined) {
  if (!value) return ''
  const date = new Date(value)
  const y = date.getFullYear().toString()
  if (y == 'NaN') return ''
...
export function humanTime(value: number | string | undefined) {
  if (!value) return ''
  if (typeof value === 'string') value = parseInt(value)
...
export function humanTimeFM(value: number | string | undefined) {
  if (!value) return ''
  if (typeof value === 'string') value = parseInt(value)
