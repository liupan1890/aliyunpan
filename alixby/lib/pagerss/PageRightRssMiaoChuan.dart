...
class _PageRightRssMiaoChuanState extends State<PageRightRssMiaoChuan> {
  ...
  Widget build(BuildContext context) {
    var itemCount = context.watch<PageRssMiaoChuanState>().pageRightMiaoChuanList.length;
    return Column(
      key: mcKey,
      children: [
        Container(
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                        ...
                        child: Text(item.logTimeStr, textAlign: TextAlign.right, style: textStyle, maxLines: 2)),
                    padding22,
                    Container(
                      height: 60,
                      child: Container(
