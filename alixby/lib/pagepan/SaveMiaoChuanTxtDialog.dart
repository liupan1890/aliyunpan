...
class SaveMiaoChuanTxtDialog extends StatefulWidget {
  SaveMiaoChuanTxtDialog({Key? key, required this.box, required this.parentid, required this.parentname})
      : super(key: key) {
    if (box == "box")
      boxname = "网盘";
    else if (box == "sbox")
  ...
  @override
  _SaveMiaoChuanTxtDialogState createState() => _SaveMiaoChuanTxtDialogState();
}
  ...
  void initState() {
    ...
    Clipboard.getData("text/plain").then((value) {
      if (value != null) {
        var text = value.text;
        if (text != null) {
          if (text.indexOf("\"DirList\"") > 0 && text.indexOf("FileList") > 0) {
                          ...
                          Container(
                              ...
                              child: RichText(
                                  ...
                                  text: TextSpan(
                                      ...
                                      children: [
                                        TextSpan(
                                            text: "请一定要把txt内的全部文字都复制完整，再粘贴到这里\n",
                                            style: TextStyle(color: MColors.textColor, fontFamily: "opposans")),
                                        TextSpan(
                                            text: "举例：{\"DirList\":[],\"FileList\":[],\"Name\":\"\",\"Size\":0}",
                                            style: TextStyle(
