...
import 'package:alixby/widgets/DownFileList.dart';
...
class _PageRightDownState extends State<PageRightDown> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    super.initState();
    print('_PageRightDownState initState');
  }
    ...
    return Column(
      children: [
        ...
        Container(
            height: 34,
            width: double.infinity,
            child: context.watch<PageDownState>().getPageName.contains("ing")
        ...
        Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
              ...
              Text(context.watch<PageDownState>().pageRightDownDes),
