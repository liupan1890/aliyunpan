  ...
  methods: {
    ...
    handleOK() {
      this.formRef.validate((data: any) => {
        ...
        if (searchid) {
          PanDAL.aShowDir('', 'search' + searchid, false)
          modalCloseAll()
        } else {
    ...
    <div class="modalbody" style="width: 440px">
      <a-form ref="formRef" :model="form" layout="horizontal" auto-label-width>
        ...
        <a-form-item field="min">
          ...
          <template #extra>
            <span style="font-size: 12px">填0不限制大小，单位兆(MB) 例如:1百兆填</span><span class="opblue" style="font-size: 12px">100</span><span style="font-size: 12px">，1GB填</span><span class="opblue" style="font-size: 12px">1024</span>
          </template>
        </a-form-item>
