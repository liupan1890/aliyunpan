...
<template>
  <a-layout style="height: 100%">
    <a-layout-sider hide-trigger :width="178" class="xbyleft">
      ...
      <a-menu :selected-keys="[appStore.GetAppTabMenu]" @update:selected-keys="appStore.toggleTabMenu('rss', $event[0])" :style="{ width: '100%' }" class="xbyleftmenu">
        ...
        <a-menu-item key="RssRename">
          <template #icon><i class="iconfont iconpiliangbianji" /></template>
          批量重命名 x
        </a-menu-item>
        ...
        <a-menu-item key="RssMakeFileTree">
