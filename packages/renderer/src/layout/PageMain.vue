...
<template>
  <a-layout style="height: 100vh" draggable="false">
    <a-layout-header id="xbyhead" draggable="false">
      <div id="xbyhead2" class="q-electron-drag">
        ...
        <a-menu mode="horizontal" :selected-keys="[appStore.appTab]" @update:selected-keys="appStore.toggleTab($event[0])">
          ...
          <a-menu-item key="down" title="Alt+3" disabled>传输</a-menu-item>
    ...
    <a-layout-footer id="xbyfoot" draggable="false">
      <div id="footer2">
        <div id="footLoading" class="footerBar fix" style="padding: 0 8px 0 0"></div>
        <div class="flexauto">
        ...
        <div id="footAria" class="footerBar fix" style="padding: 0 8px"></div>
        <div style="padding: 0 8px">{{ Config.appVersion }}</div>

        <a-popover trigger="click" position="top" class="asynclist" v-model:popup-visible="footStore.visible">
          <div class="footerBar fix">
          ...
          <template #content>
            <div style="width: 320px; min-height: 120px">
